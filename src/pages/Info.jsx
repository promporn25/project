...
export default function EditProfile() {
  ...
  const [dark, setDark] = useState(false); // สวิตช์บนแถบดำ (แค่เปลี่ยนพื้นหลัง)
...
function btn(variant) {
  ...
  if (variant === "primary")
    return { ...base, background: "#2a63ff", color: "#fff" };
  if (variant === "success")
  ...
  if (variant === "danger")
    return {
      ...
      background: "#8f2a2a",
      color: "#fff",
      marginLeft: "auto", // ให้ Log Out ไปอยู่ซ้ายล่างเหมือนภาพ (ชิดซ้ายของกลุ่ม)
